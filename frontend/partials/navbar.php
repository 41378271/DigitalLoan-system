    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center gap-4">
                ...
                <!-- Notification Bell -->
                <a href="<?= $basePath ?>/notifications" class="relative p-2 text-gray-500 transition-colors bg-white rounded-full hover:bg-gray-100 hover:text-gray-700">
                ...
                <div class="relative ml-2">
                    <div class="flex items-center gap-3">
                        ...
                        <a href="<?= $basePath ?>/profile" class="flex text-sm bg-brand-100 rounded-full focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 w-9 h-9 items-center justify-center">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", async () => {
        try {
            const res = await fetch("<?= $basePath ?? '' ?>/backend/api/notifications/unread_count.php");
